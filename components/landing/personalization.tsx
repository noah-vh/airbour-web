...
export function Personalization() {
  ...
  return (
    <section className="py-12 md:py-20 section-dark-tint section-bordered">
      <div className="container-wide">
        {/* Mobile: Stacked compact layout */}
        <div className="lg:hidden">
          <div className="text-center mb-6">
            <p className="section-label mb-2">Personalization</p>
            <h2 className="font-serif text-2xl tracking-tight mb-2">
              It learns you
            </h2>
            <p className="text-sm text-[var(--foreground-secondary)]">
              Adapts to your industry, competitors, and blind spots.
            </p>
          </div>

          <div className="bg-[var(--background-elevated)] border border-[var(--border)] p-4 rounded-xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <div className="font-medium text-sm">Intelligence Profile</div>
                <div className="text-[10px] text-[var(--foreground-muted)]">Learning from you</div>
              </div>
            </div>
              ...
              {interests.slice(0, 3).map((interest) => (
                <div key={interest.label}>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-xs text-[var(--foreground-muted)]">{interest.value}%</span>
                  </div>
